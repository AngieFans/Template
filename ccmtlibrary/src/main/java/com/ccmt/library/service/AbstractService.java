...
public abstract class AbstractService extends Service {
    ...
    @SuppressWarnings("unused")
    public static AbstractService getService(Class<? extends AbstractService> cla) {
        return Global.allRunningServices.get(cla);
    }
...
//        }
        if (!Global.allRunningServices.containsKey(cla)) {
            Global.allRunningServices.put(cla, this);
        }
    }

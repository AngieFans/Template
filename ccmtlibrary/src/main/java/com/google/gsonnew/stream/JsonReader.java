...
import com.google.gsonnew.internal.bind.JsonTreeReader;
...
public class JsonReader implements Closeable {
  ...
  public double nextDouble() throws IOException {
    ...
    if (!lenient && (Double.isNaN(result) || Double.isInfinite(result))) {
      throw new com.google.gsonnew.stream.MalformedJsonException("JSON forbids NaN and infinities: " + result
          + " at line " + getLineNumber() + " column " + getColumnNumber());
    }
    peekedString = null;
    peeked = PEEKED_NONE;
  ...
  private IOException syntaxError(String message) throws IOException {
    throw new com.google.gsonnew.stream.MalformedJsonException(message
        + " at line " + getLineNumber() + " column " + getColumnNumber());
  }

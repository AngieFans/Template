...
//            case R.id.title:
    ...
    public void setSettingBtnResource(int resid) {
        mSettingBtn.setImageResource(0);
        mSettingBtn.setBackgroundResource(resid);
        mSettingBtn.setVisibility(VISIBLE);
    }

    public void setBackBtnResource(int resid) {
        mBackImageBtn.setImageResource(0);
        mBackImageBtn.setBackgroundResource(resid);
        mBackImageBtn.setVisibility(VISIBLE);
    }

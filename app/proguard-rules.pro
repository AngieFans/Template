...
#-keep public class * extends com.ccmt.template.activity.**
#-keep public class * extends com.ccmt.template.service.**
...
# 保持反射类不被混淆
#-keep public class com.ccmt.template.util.ReflectUtils {*;}

# 保持app的类不被混淆
-keep public class com.ccmt.template.keeplive.KeepLiveManager {*;}

# 保持app的内部类不被混淆
-keep public com.ccmt.library.R$*{
    public static final int *;
}
-keep public class com.ccmt.template.R$*{
    public static final int *;
}
...
-keep class * extends android.net.http.SslError {*;}
